...
# ----------------------------------------
# ACDS 17.0 595 win32 2017.09.25.11:34:21
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/clock_buff_altclkctrl_0.v" -work altclkctrl_0
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clock_buff.v"                                           
}
