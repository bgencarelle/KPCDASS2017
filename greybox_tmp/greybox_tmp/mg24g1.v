//altdpram CBX_SINGLE_OUTPUT_FILE="ON" INDATA_ACLR="OFF" INDATA_REG="INCLOCK" INTENDED_DEVICE_FAMILY=""MAX 10"" LPM_TYPE="altdpram" MAXIMUM_DEPTH=1024 OUTDATA_ACLR="OFF" OUTDATA_REG="UNREGISTERED" RDADDRESS_ACLR="OFF" RDADDRESS_REG="INCLOCK" RDCONTROL_ACLR="OFF" RDCONTROL_REG="INCLOCK" READ_DURING_WRITE_MODE_MIXED_PORTS="OLD_DATA" USE_EAB="OFF" WIDTH=24 WIDTH_BYTEENA=1 WIDTHAD=10 WRADDRESS_ACLR="OFF" WRADDRESS_REG="INCLOCK" WRCONTROL_ACLR="OFF" WRCONTROL_REG="INCLOCK" data inclock outclock q rdaddress rden wraddress wren
