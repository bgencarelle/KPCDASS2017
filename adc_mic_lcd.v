...
//=======================================================
// ### USER DEFINED
wire  [RANGE:0]		PWM_OUT;
wire 	[RANGE:0]		MEM0_OUT;
wire  [RANGE:0]		SEED_OUT;
wire  [RANGE:0] 		FILTER_OUT;
wire  [RANGE:0]		MUX0_OUT;
wire	[RANGE:0]		MUX1_OUT;
wire	[RANGE:TRUNC] 	MASTER_OUT;
wire 			  			key_0;
reg 			  			GPIOCLK;
wire 	[6:0]	  			HEXR;
...
assign MASTER_OUT =MEM0_OUT[RANGE:TRUNC];

pulse_width_modulation_gen pwm1 (//to do: add frequency control)
    .clk(MAX10_CLK1_50 ), 
	 .outclk(AUDIO_WCLK),
	 .reset(RESET_DELAY_N),
    .q_pwm(PWM_OUT[RANGE:0])
// .q_saw()
