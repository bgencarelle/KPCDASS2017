...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_modular_adc_response_merge.v"      -work response_merge_internal  
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_modular_adc_dual_sync.v"           -work dual_sync_internal       
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_modular_adc_conduit_splitter.v"    -work conduit_splitter_internal
  ...
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/adc_mult_modular_dual_adc_0.v"            -work modular_dual_adc_0       
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/adc_mult.v"                                                                         
fi
