...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/altera_modular_adc_response_merge.v \
  $QSYS_SIMDIR/submodules/altera_modular_adc_dual_sync.v \
  $QSYS_SIMDIR/submodules/altera_modular_adc_conduit_splitter.v \
  ...
  $QSYS_SIMDIR/submodules/adc_mult_modular_dual_adc_0.v \
  $QSYS_SIMDIR/adc_mult.v \
  -top $TOP_LEVEL_NAME
# ----------------------------------------
# simulate
